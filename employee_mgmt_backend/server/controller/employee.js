...
export function employee_list(req, res) {
  const filter = {};
...
export function employee_create(req, res) {
...
export function employee_bulk_delete(req, res) {
...
// Get employee detail
export function employee_detail(req, res) {
  let documentId;
  try {
...
// update employee
export function employee_update(req, res) {
  let documentId;
  try {
    documentId = mongoose.Types.ObjectId(req.params.id);
  } catch (error) {
...
// delete employee
export function employee_delete(req, res) {
  let docId;
  try {
